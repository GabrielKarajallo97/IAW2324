...
<div class="container">
    <table class="table table-striped table-bordered table-hover">
        <thead class="table">
            <tr>
                <th scope="col"><a href="orden_usuarios.php">Usuario</a></th>
                <th scope="col"><a href="orden_correo.php">Correo</a></th>
        ...
        <tbody>
            <tr>
                ...
                <?php
                $query = "SELECT * FROM usuarios order by gmail";
                $vista_usuarios = mysqli_query($conn, $query);
                $totalq = "SELECT gmail FROM usuarios group by username";
